...
# input - one line of input containing space separated floating number values of the X, Y and Z coordinates of a point
# 0 4 5
# 1 7 6
# 0 5 9
# 1 7 2
...
class Points(object):
    ...
    # calculate the magnitude or geometric length of the vector
    def absolute(self):
        return pow((self.x ** 2 + self.y ** 2 + self.z ** 2), 0.5)

# boiler plate for exercise
